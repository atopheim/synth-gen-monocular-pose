...
from lib.utils.data_utils_homemade import HomemadeModelDB, Projector
...
from lib.datasets.homemade_dataset import VotingType
...
class Evaluator(object):
    def __init__(self):
        self.homemade_db = HomemadeModelDB()
    ...
    def evaluate(self, points_2d, pose_targets, class_type, intri_type='blender', vote_type=VotingType.BB8, intri_matrix=None):
        ...
        model = self.homemade_db.get_ply_model(class_type)
        diameter = self.homemade_db.get_diameter(class_type)
