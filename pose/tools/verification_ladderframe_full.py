...
train_cfg['model_name'] = '{}_{}'.format('ladderframe', train_cfg['model_name'])
...
def read_data(idx):
    ...
    demo_dir = os.path.join(cfg.DATA_DIR,'demo','ladderframe')
    source_dir = '/media/volvomlp2/03C796544677EF72/BBB/HOMEMADE/renders/ladderframe'
    ...
    points_3d = np.loadtxt(os.path.join(demo_dir, 'ladderframe_points_3d.txt')) ##DEEMO DIR
    bb8_3d = np.loadtxt(os.path.join(cfg.HOMEMADE,'ladderframe','corners.txt'))
...
def demo(idx):
    ...
    model_dir = os.path.join(cfg.MODEL_DIR, "ladderframe_demo")
