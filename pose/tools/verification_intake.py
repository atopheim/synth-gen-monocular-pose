...
def read_data(idx):
    ...
    #mask[mask != 0] = 1
    points_3d = np.loadtxt(os.path.join(demo_dir, 'intake_points_3d.txt'))
    bb8_3d = np.loadtxt(os.path.join('/home/volvomlp2/python-envs/pvnet/data/HOMEMADE/intake/corners.txt'))
...
if __name__ == "__main__":
    for idx in range(0,16):#(3482,3500):
        demo(idx)